        ...
        <Accordion>
            ...
            <Accordion.Collapse eventKey="1">
              <Card.Body>
                ...
                <p>
                  ...
                  auctions until an auction is won. If you
                </p>
                <h3>How can I withdraw my funds</h3>
                <p>
                  You can withdraw your funds at anytime outside of an active bid. An active bid
                  occurs when the nouns party vault has more ethereum than the current largest
                  bidder in the {nounsLink} auction. We only allow the party to submit their bid
                  within the final hour of the auction.
                </p>
          ...
          <Card className={classes.card}>
            ...
            <Accordion.Collapse eventKey="3">
              <Card.Body>
                <p>
                  The nouns party team is a collective of 4 people that formed to help contribute to
                  the nouns ecosystem. We are an active member of the nouns DAO governance and own
                  noun#13.
                </p>
                <ul>
                  <li>@devloper_eth</li>
                ...
                <p>
                  Because 100% of the vault funding will be contributed to the nounsdao auctions,
                  the nouns party team has chosen to be compensated in fractions of the nouns which
                  are won by the nouns party vault. The team will only be compensated in nouns
                  shares and will only be compensated when an auction is won.
                </p>

                <p>
                  The nouns DAO and the nouns party team have agreed to reward the team 2.5% of the
                  noun shares earned through auctions won on nouns party.
                </p>

                <p>
                  As a result, nouns party funders can expect 2.5% fewer tokens than their initial
                  vault contribution. For example, if a noun is won for 200E and is tokenized into
                  200,000 tokens, the vault funders will receive 200,000 less 2.5%, or 195,000
                  tokens distributed in proportion to the amount each funder contributed to the
                  vault.
                </p>

                <p>This 2.5% of noun shares is distributed to the nouns party multisig.</p>
              </Card.Body>
            </Accordion.Collapse>
          </Card>
        </Accordion>
